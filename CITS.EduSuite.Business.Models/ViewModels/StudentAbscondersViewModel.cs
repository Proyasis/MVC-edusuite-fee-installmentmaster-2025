...
{
   public class StudentAbscondersViewModel:BaseModel
    {
       public StudentAbscondersViewModel()
       {
           AbscondersDate = DateTimeUTC.Now;
        ...
        public string IsAbscondersText { get { return IsAbsconders ? EduSuiteUIResources.Yes : EduSuiteUIResources.Pending; } }
