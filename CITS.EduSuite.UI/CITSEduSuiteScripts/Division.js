var Division = (function () {
    var getDivision = function () {
        ...
        $("#grid").jqGrid({
            ...
            colNames: [Resources.RowKey, Resources.Division, Resources.IsActive, Resources.Action],
            colModel: [
        ...
        $("#grid").jqGrid("setLabel", "DivisionName", "", "thDivisionName");
    }


    function editLink(cellValue, options, rowdata, action) {
        var temp = "'" + rowdata.RowKey + "'";
        return '<div class="divEditDelete"><a data-modal="" class="btn btn-outline-primary btn-sm mx-1" data-href="' + $("#hdnAddEditDivision").val() + '/' + rowdata.RowKey + '"><i class="fa fa-pencil" aria-hidden="true"></i></a>' + '<a class="btn btn-outline-danger btn-sm mx-1" href="#"   onclick="javascript:deleteDivision(' + temp + ');return false;"><i class="fa fa-trash" aria-hidden="true"></i></a></div>';
    }
    return {
...
function deleteDivision(rowkey) {
    var result = EduSuite.Confirm({
        title: Resources.Confirmation,
        content: Resources.Delete_Confirm_Division,
        actionUrl: $("#hdnDeleteDivision").val(),
        actionValue: rowkey,
