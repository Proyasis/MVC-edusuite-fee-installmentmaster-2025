var Religion = (function () {
    var getReligion = function () {
        ...
        $("#grid").jqGrid({
            ...
            colNames: [Resources.RowKey, Resources.Religion , Resources.IsActive, Resources.Action],
            colModel: [
        ...
        $("#grid").jqGrid("setLabel", "ReligionName", "", "thReligionName");
    }


    function editLink(cellValue, options, rowdata, action) {
        var temp = "'" + rowdata.RowKey + "'";
        return '<div class="divEditDelete"><a data-modal="" class="btn btn-outline-primary btn-sm mx-1" data-href="' + $("#hdnAddEditReligion").val() + '/' + rowdata.RowKey + '"><i class="fa fa-pencil" aria-hidden="true"></i></a>' + '<a class="btn btn-outline-danger btn-sm  mx-1" href="#"   onclick="javascript:deleteReligion(' + temp + ');return false;"><i class="fa fa-trash" aria-hidden="true"></i></a></div>';
    }
    return {
...
function deleteReligion(rowkey) {
    var result = EduSuite.Confirm({
        title: Resources.Confirmation,
        content: Resources.Delete_Confirm_Religion,
        actionUrl: $("#hdnDeleteReligion").val(),
        actionValue: rowkey,
