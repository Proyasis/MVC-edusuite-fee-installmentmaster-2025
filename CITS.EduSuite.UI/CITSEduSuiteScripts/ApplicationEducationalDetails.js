var ApplicationEducationalDetails = (function () {
    var getApplicationEducationalDetails = function (json) {
        ...
        $('.repeater').repeater({
            ...
            data: json,
            repeatlist: 'ApplicationEducationalDetails',
    ...
    return {
        GetApplicationEducationalDetails: getApplicationEducationalDetails
    }
