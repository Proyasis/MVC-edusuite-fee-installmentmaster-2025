    ...
    var t = {
        ...
        isAnyActive: function (t) {
            ...
            return e.each(t, function (e, t) {
                return i.breakpoints[t].is(":visible") ? (n = !0,
                !1) : void 0
            }),
            n
        },
    ...
    e.fn.jScrollPane = function (t) {
        function i(t, i) {
            function n(i) {
                ...
                I.clickOnTrack && p(),
                z(),
                I.hijackInternalLinks && W()) : (t.removeClass("jspScrollable"),
                L.css({
                    top: 0,
                    left: 0,
                    width: F.width() - me
            ...
            function o() {
                ...
                ne = ie.find(">.jspTrack"),
                U = ne.find(">.jspDrag"),
                I.showArrows && (ae = e('<a class="jspArrow jspArrowUp" />').bind("mousedown.jsp", u(0, -1)).bind("click.jsp", M),
                le = e('<a class="jspArrow jspArrowDown" />').bind("mousedown.jsp", u(0, 1)).bind("click.jsp", M),
                I.arrowScrollOnHover && (ae.bind("mouseover.jsp", u(0, -1, ae)),
            ...
            function r() {
                K && (F.append(e('<div class="jspHorizontalBar" />').append(e('<div class="jspCap jspCapLeft" />'), e('<div class="jspTrack" />').append(e('<div class="jspDrag" />').append(e('<div class="jspDragLeft" />'), e('<div class="jspDragRight" />'))), e('<div class="jspCap jspCapRight" />'))),
                ce = F.find(">.jspHorizontalBar"),
                ue = ce.find(">.jspTrack"),
                J = ue.find(">.jspDrag"),
                I.showArrows && (fe = e('<a class="jspArrow jspArrowLeft" />').bind("mousedown.jsp", u(-1, 0)).bind("click.jsp", M),
                he = e('<a class="jspArrow jspArrowRight" />').bind("mousedown.jsp", u(1, 0)).bind("click.jsp", M),
                I.arrowScrollOnHover && (fe.bind("mouseover.jsp", u(-1, 0, fe)),
            ...
            function l() {
                ...
                V = L.outerHeight(),
                Q = V / q,
                K && (pe = Math.ceil(1 / G * de),
                pe > I.horizontalDragMaxWidth ? pe = I.horizontalDragMaxWidth : pe < I.horizontalDragMinWidth && (pe = I.horizontalDragMinWidth),
                J.width(pe + "px"),
                ee = de - pe,
                j(te)),
                $ && (re = Math.ceil(1 / Q * se),
                re > I.verticalDragMaxHeight ? re = I.verticalDragMaxHeight : re < I.verticalDragMinHeight && (re = I.verticalDragMinHeight),
                U.height(re + "px"),
                Z = se - re,
                g(_))
            }
            ...
            function v(i, n) {
                if ($) {
                    ...
                    !o.isDefaultPrevented()) {
                        ...
                        n ? be.animate(U, "top", i, g, function () {
                ...
                if (K) {
                    ...
                    !o.isDefaultPrevented()) {
                        var s = i || 0
                          ...
                          , c = -l * (N - O);
                        void 0 === n && (n = I.animateScroll),
                        n ? be.animate(J, "left", i, j, function () {
            ...
            function b(e, t) {
                I.showArrows && (ae[e ? "addClass" : "removeClass"]("jspDisabled"),
                le[t ? "addClass" : "removeClass"]("jspDisabled"))
            }
            function w(e, t) {
                I.showArrows && (fe[e ? "addClass" : "removeClass"]("jspDisabled"),
            ...
            function W() {
                ...
                e(document.body).delegate('a[href*="#"]', "click", function (t) {
                    ...
                    l === c) {
                        ...
                        n.length && (o = n.closest(".jspScrollable"),
                        s = o.data("jsp"),
                        s.scrollToElement(n, !0),
                        o[0].scrollIntoView && (r = e(window).scrollTop(),
                        a = n.offset().top,
                        (r > a || a > r + e(window).height()) && o[0].scrollIntoView()),
                        t.preventDefault())
                    }
                }))
            }
            ...
            me = 0) : (ge = t.css("paddingTop") + " " + t.css("paddingRight") + " " + t.css("paddingBottom") + " " + t.css("paddingLeft"),
            me = (parseInt(t.css("paddingLeft"), 10) || 0) + (parseInt(t.css("paddingRight"), 10) || 0)),
            e.extend(be, {
        ...
        this.each(function () {
            var n = e(this)
              , o = n.data("jsp");
            o ? o.reinitialise(t) : (e("script", n).filter('[type="text/javascript"],:not([type])').remove(),
            o = new i(n, t),
            n.data("jsp", o))
        })
    }
