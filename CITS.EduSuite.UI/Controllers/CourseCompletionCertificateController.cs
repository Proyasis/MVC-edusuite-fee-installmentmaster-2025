...
{
    public class CourseCompletionCertificateController : BaseController
    {
        private ICourseCompletionCertificateService CourseCompletionCertificateService;
        private ISelectListService selectListService;
        private INotificationTemplateService notificationTemplateService;
        public CourseCompletionCertificateController(ICourseCompletionCertificateService objCourseCompletionCertificateService,
            ISelectListService objselectListService
            , INotificationTemplateService objnotificationTemplateService)
        {
            this.CourseCompletionCertificateService = objCourseCompletionCertificateService;
            this.selectListService = objselectListService;
            this.notificationTemplateService = objnotificationTemplateService;
        }

        [ActionAuthenticationAttribute(MenuCode = MenuConstants.CourseCompletionCertificate, ActionCode = ActionConstants.View)]
        [HttpGet]
        public ActionResult CourseCompletionCertificateList()
        {
        ...
        public JsonResult GetApplications(string ApplicantName, string MobileNumber, short? BranchKey, long? CourseKey, short? UniversityKey, short? BatchKey, string sidx, string sord, int page, int rows)
        {
            ...
            applicationList = CourseCompletionCertificateService.GetApplications(objViewModel, out TotalRecords);
        ...
        public JsonResult FetchCourseCompletionCertificateDetails(CourseCompletionCertificateViewModel model)
        {
            List<dynamic> FetchCourseCompletionCertificateDetails = new List<dynamic>();
            FetchCourseCompletionCertificateDetails = CourseCompletionCertificateService.FetchCourseCompleteCertificate(model);

            return Json(FetchCourseCompletionCertificateDetails, JsonRequestBehavior.AllowGet);
        }

        [ActionAuthenticationAttribute(MenuCode = MenuConstants.CourseCompletionCertificate, ActionCode = ActionConstants.AddEdit)]
        public ActionResult AddEditCourseCompletionCertificate(long? id, long? ApplicationKey)
        {
            ...
            model = CourseCompletionCertificateService.GetCourseCompletionCertificateById(model);
            if (model == null)
            {
                model = new CourseCompletionCertificateViewModel();
            }
        ...
        [HttpPost]
        public ActionResult AddEditCourseCompletionCertificate(CourseCompletionCertificateViewModel model)
        {
            if (ModelState.IsValid)
            {
                if (model.RowKey == 0)
                {
                    model = CourseCompletionCertificateService.CreateCourseCompletionCertificate(model);
                }
                else
                {
                    model = CourseCompletionCertificateService.UpdateCourseCompletionCertificate(model);
        ...
        [ActionAuthenticationAttribute(MenuCode = MenuConstants.CourseCompletionCertificate, ActionCode = ActionConstants.Delete)]
        public ActionResult DeleteCourseCompletionCertificate(long Id)
        {
            CourseCompletionCertificateViewModel objviewModel = new CourseCompletionCertificateViewModel();
            try
            {
                objviewModel = CourseCompletionCertificateService.DeleteCourseCompletionCertificate(Id);
            }
            catch (Exception)
            {
        ...
        public void SendNotificationInBackground(CourseCompletionCertificateViewModel model)
        {
        ...
        private void SendNotification(Object model)
        {
            ...
            CourseCompletionCertificateViewModel objViewModel = (CourseCompletionCertificateViewModel)model;
